...
export function DeliverPageStrip() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-sidebar">
      <div className="flex h-7 shrink-0 items-center border-b border-sidebar-border bg-sidebar-accent px-2">
        <span className="text-tiny font-medium text-sidebar-foreground">Spreads</span>
      </div>
