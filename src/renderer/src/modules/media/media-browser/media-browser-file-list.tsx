...
import { MediaBrowserFileListFolder } from './media-browser-file-list-folder';
import { MediaFileListHeader } from './media-browser-file-list-header';
import { MediaBrowserFileListPhoto } from './media-browser-file-list-photo';

type MediaBrowserFileListProps = {
  folders: PhotoFolder[];
  photos: PhotoItem[];
...
export const MediaBrowserFileList = ({
  folders,
  photos,
  selectedPhotoId,
